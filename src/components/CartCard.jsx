      ...
      <div className="flex flex-col gap-4 max-w-[250px]">
        ...
        <div className="flex flex-row gap-20">
          ...
          <button 
            ...
            className="w-[112px] h-6 text-base/[22.4px] text-center text-[#004D3D] border border-[#004D3D] rounded-lg hover:bg-dark-green hover:text-white hover:font-medium hover:outline-none"
          >
            Remove
          </button>
        </div>
